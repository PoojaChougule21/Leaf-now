...
<head>
    ...
    <style>
        h1 {
            ...
            font-family: Arial Black, Haettenschweiler, 'Arial Narrow Bold', serif;
            text-align: center;
            cursor: pointer;
            color:green;
            /* font-size:20px; */
        ...
        <form action="EditProfile.php" method="post">
            <table align="center">
                ...
                <tr align="center">
                    ...
                    <input type="tel" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="<?php echo $phone ?>">   
                </tr>
                <tr align="center">
