      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                     ...
                     <a class="float-left" href="#">
                          <img src="leaf4.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
                     </a>
                </div>
                ...
                <a class="float-left" href="farmerHomepage.php">
                     <img src="leaf4.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
                </a>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Website/donate4.jpg" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/donate2.png" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/donate3.jpeg" alt="Second slide">
                          </div>
           ...
           <div class="features container">
                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     ...
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/donate.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">Donate</h4>
                               <br>
                               <h5 class="card-text">Donate plants or money  to plant enthusiasts to support Go Green </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/group.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold"> Group Formation</h4>
                               <br>
                               <h5 class="card-text">Get in touch with other people to save the nature </h5>
                          </div>
                     </div>
                </div>
           </div>
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u><a href="https://www.agrocraft.com/">Leaf Now</a></u> is a </p>
                               <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Leaf Now
                               </a></p>
                          </div>
                          </hr>
                     </div>
