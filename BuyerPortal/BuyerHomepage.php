...
<head>
	...
	<title>Leaf Now Buyer page</title>
...
<body>
	...
	<div class="headerdown">
		<div id="show">
			<div class="sel3 sel">
				<button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">OTHER</i>
			...
			<div class="sel2 sel">
				<button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">FLOWERS</i>
					<span class="caret"></span></button>
				<ul class="dropdown-menu ">
					<?php getVegetables(); ?>
				</ul>
	...
	<div class="instaid">
		...
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">leafnow22@gmail.com</a></div>

	</div>


	<div class="copy">
		<h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.leafnow.com</h5>
	</div>
</body>
