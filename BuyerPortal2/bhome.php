...
<body>
    ...
    <div class="container"> <img src="b5.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <h1 id="headings" class="guard"><span><b>Fruit plants </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        <div class="text-center">
            <!-- <h2 id="headings" class="destext">Fresh fruits</h2> -->
            <h1 id="headings" class="guard"><span><b>Flowes </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>All Plants or Seeds  </b></span>
            </h1>
        </div>
        <br>
        <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.agrocraft.com/">Leaf Now</a></u> is a to connect the nature enthusiasts which aims to attain Green Initiative</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Leaf Now</a></p>
                </div>
                </hr>
            </div>
        </div>
